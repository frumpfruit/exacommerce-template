...
export default function Footer({ onNavigate }) {
  return (
    <footer style={{ 
      ...
      paddingTop: 'var(--dist-space-8)',
      borderTop: '4px solid var(--dist-brand-primary)'
    }}>
      <div className="dist-container">
        {/* Mega Footer Grid */}
        <div className="dist-footer-grid" style={{ marginBottom: 'var(--dist-space-8)' }}>
          
          {/* Col 1: Brand & Data */}
          <div>
            <div style={{ 
              fontSize: '28px', fontWeight: 800, letterSpacing: '-1px',
              color: 'white', marginBottom: 'var(--dist-space-3)',
              display: 'flex', alignItems: 'center', gap: '8px'
            }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--dist-brand-primary)" strokeWidth="3">
                <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path>
              </svg>
              NEXUS
            </div>
            <p style={{ fontSize: '14px', lineHeight: 1.6, marginBottom: 'var(--dist-space-4)', maxWidth: '280px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '12px' }}>
              ...
              <div><strong>System Status:</strong> <span style={{ color: 'var(--dist-status-success)' }}>● 100% Operational</span></div>
            </div>
          </div>
          ...
          <div>
            ...
            `}</style>
            <div className="dist-footer-subscribe">
              ...
              <button style={{ 
                backgroundColor: 'var(--dist-brand-primary)', border: 'none', 
