    ...
    <div style={{ backgroundColor: 'var(--retail-surface-raised)', padding: 'var(--retail-space-10) 0' }}>
      <div className="retail-container">
        ...
        <ScrollReveal>
          ...
          <h1 className="retail-heading" style={{ textAlign: 'center', fontSize: 'var(--retail-text-xl)', marginBottom: 'var(--retail-space-9)' }}>
            Contact <span style={{ color: 'var(--retail-border-strong)' }}>HAVEN</span>
          </h1>
        </ScrollReveal>
        ...
        <div style={{
          ...
          {/* Left panel: Info */}
          <ScrollReveal>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--retail-space-7)' }}>
              <div>
                <h2 style={{
                  fontSize: '18px',
                  fontWeight: 700,
                  ...
                  Flagship <span style={{ color: 'var(--retail-border-strong)' }}>Showroom</span>
                </h2>
                <p style={{ fontSize: 'var(--retail-text-md)', color: 'var(--retail-text-secondary)', lineHeight: 1.6, margin: 0 }}>
              ...
              <div>
                <h2 style={{
                  ...
                  Showroom Desk & <span style={{ color: 'var(--retail-border-strong)' }}>Advisory</span>
                </h2>
                <p style={{ fontSize: 'var(--retail-text-md)', color: 'var(--retail-text-secondary)', lineHeight: 1.6, margin: 0 }}>
              ...
              <div style={{
                ...
                <svg width="100%" height="100%" viewBox="0 0 300 200" fill="none" style={{ position: 'absolute', top: 0, left: 0 }}>
                  ...
                  <circle cx="180" cy="110" r="16" fill="var(--retail-border-strong)" fillOpacity="0.15" />
                  <circle cx="180" cy="110" r="6" fill="var(--retail-border-strong)" />
                </svg>
                <div style={{
                  position: 'relative',
                  zIndex: 2,
                  backgroundColor: 'rgba(255, 255, 255, 0.9)',
                  padding: 'var(--retail-space-2) var(--retail-space-4)',
          ...
          <ScrollReveal delay={150}>
            <div style={{
              ...
              border: '1px solid var(--retail-surface-muted)',
              borderRadius: 'var(--retail-radius-xs)',
              padding: 'var(--retail-space-7) var(--retail-space-7)',
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--retail-space-5)' }}>
                  <h2 style={{
                    fontSize: '18px',
                    fontWeight: 700,
                    textTransform: 'uppercase',
                    ...
                    Send Us A <span style={{ color: 'var(--retail-border-strong)' }}>Message</span>
                  </h2>
                  <p style={{ fontSize: '12px', color: 'var(--retail-text-secondary)', margin: '0 0 var(--retail-space-3)' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--retail-space-1)' }}>
                    <label style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: 'var(--retail-text-secondary)' }}>Full Name *</label>
                    <input 
                      type="text" 
                      required 
                      value={formData.name} 
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--retail-space-1)' }}>
                    <label style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: 'var(--retail-text-secondary)' }}>Email Address *</label>
                    <input 
                      type="email" 
                      required 
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--retail-space-1)' }}>
                    <label style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: 'var(--retail-text-secondary)' }}>Subject</label>
                    <input 
                      type="text" 
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--retail-space-1)' }}>
                    <label style={{ fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', color: 'var(--retail-text-secondary)' }}>Message *</label>
                    <textarea 
                      required 
                      rows={4}
                  ...
                  <button type="submit" className="retail-btn retail-btn-primary" style={{ marginTop: 'var(--retail-space-3)' }}>
                    Send Message
                  </button>
                </form>
              )}
