      ...
      <AnimatePresence>
        {isCartOpen && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            style={{ position: 'fixed', inset: 0, zIndex: 100, display: 'flex', justifyContent: 'flex-end', backgroundColor: 'rgba(0,0,0,0.5)' }}
          >
            <motion.div 
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              ...
              style={{ width: '100%', maxWidth: '420px', backgroundColor: '#FFFFFF', height: '100%', display: 'flex', flexDirection: 'column', padding: '30px' }} className="shadow-2xl"
            >
