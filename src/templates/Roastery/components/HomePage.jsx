...
import { fadeUp, fadeLeft, fadeRight, fade, scaleIn, heroTitle, heroSub } from '../motionPresets';
...
export default function HomePage({ onNavigate, onToggleCartItem, cart }) {
  ...
  return (
    <div className="text-on-surface font-body-md" style={{ backgroundColor: brand.cream }}>
      ...
      <section className="relative w-full min-h-[calc(100vh_-_72px)] flex flex-col lg:flex-row" style={{ backgroundColor: brand.deepBlue }}>
        <div className="w-full h-[50vh] lg:h-[calc(100vh_-_72px)] lg:w-[55%] relative">
          <img
        ...
        <div className="w-full lg:w-[45%] flex-1 flex flex-col justify-center px-8 py-16 md:px-12 lg:px-16 lg:py-20" style={{ backgroundColor: brand.deepBlue, color: brand.white }}>
          <motion.div
            {...heroTitle}
          >
        ...
        {/* Wave Separator full width at the bottom of Hero Section */}
        <div className="absolute bottom-[-1px] left-0 w-full overflow-hidden leading-[0] z-20">
          <svg className="relative block w-full h-[30px] md:h-[50px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.08,130.83,115.5,188.4,98.67,243.6,82.52,284.14,63.14,321.39,56.44Z" fill={brand.softMint}></path>
          </svg>
        </div>
      </section>
      ...
      <section className="relative w-full flex flex-col">
        ...
        <motion.div
          {...fadeUp}
          className="relative w-full flex flex-col bg-center bg-cover bg-no-repeat " style={{ backgroundImage: "url('/images/roastery/kevin-schmid-ftA71vetxuo-unsplash.jpg')", backgroundBlendMode: "overlay", backgroundColor: "rgba(247, 249, 255, 0.85)" }}>
          ...
          <div className="w-full overflow-hidden leading-[0] mt-auto relative z-10 -mb-[1px]">
      ...
      <section className="pt-24 relative flex flex-col" style={{ backgroundColor: brand.white }}>
        <div className="max-w-[1280px] mx-auto px-8 md:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0 pb-8 md:pb-12">
          <motion.div
            initial={{ opacity: 0, x: -40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: '-80px' }}
        ...
        <div className="w-full overflow-hidden leading-[0] mt-auto -mb-[1px]">
      ...
      >
        ...
        <motion.div
          ...
          <div className="flex flex-col lg:flex-row h-auto lg:h-[600px] rounded-[2px] overflow-hidden shadow-2xl relative transition-colors duration-1000" style={{ backgroundColor: [brand.onSurface, "#1a0a00", brand.deepBlue, "#2C1503"][currentSlide % 4], color: [brand.softMint, brand.softMint, brand.white, brand.softMint][currentSlide % 4] }}>

            <div className="w-full lg:w-1/2 h-[350px] md:h-[450px] lg:h-full relative overflow-hidden">
            ...
            <div className="w-full lg:w-1/2 relative h-[400px] md:h-[450px] lg:h-full overflow-hidden">
              {featuredProducts.map((prod, idx) => (
      ...
      <section className="w-full flex flex-col">
        ...
        <motion.div
          {...fade}
          className="flex flex-col lg:flex-row min-h-0 lg:min-h-[500px]">
          <motion.div
            {...fadeLeft}
            className="w-full lg:w-[60%] h-[40vh] lg:h-auto relative">
            <img src="/images/roastery/kevin-schmid-ftA71vetxuo-unsplash.jpg" alt="Coffee farm" className="absolute inset-0 w-full h-full object-cover" />
          </motion.div>
          <motion.div
            {...fadeRight}
        ...
        <motion.div
          ...
          <motion.div
            {...fadeRight}
            className="w-full lg:w-[60%] h-[40vh] lg:h-auto relative">
            <img src="/images/roastery/skylar-michael-SwmUmhrFr54-unsplash.jpg" alt="Roasting beans" className="absolute inset-0 w-full h-full object-cover" />
          </motion.div>
        </motion.div>
      </section>
      ...
      <motion.section
        {...fade}
        className="w-full flex flex-col lg:flex-row lg:min-h-[600px]" style={{ backgroundColor: brand.cream }}>
        <div className="w-full lg:w-[50%] h-[40vh] lg:h-auto relative">
          <img src="/images/roastery/jason-betz-klub_Ke-268-unsplash.jpg" alt="Coffee bag on table" className="absolute inset-0 w-full h-full object-cover" />
        </div>
            ...
            <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-8">
              <div className="flex flex-col cursor-pointer group">
                <div className="h-[200px] w-full overflow-hidden mb-6 rounded-sm">
                  <img src="/images/roastery/charles-sims-k-w7laFKa0g-unsplash.jpg" alt="Roasting" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
              ...
              <div className="flex flex-col cursor-pointer group">
                <div className="h-[200px] w-full overflow-hidden mb-6 rounded-sm">
                  <img src="/images/roastery/jason-betz-klub_Ke-268-unsplash.jpg" alt="Brewing" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
                <p className="uppercase text-[11px] tracking-[3px] font-bold mb-3" style={{ color: brand.coral }}>Brewing</p>
                <h3 className="text-[22px] font-bold font-display-lg leading-tight mb-4 group-hover:opacity-70 transition-opacity" style={{ color: brand.onSurface }}>
                  Why We Measure Extraction by Weight, Not Volume
                </h3>
                <span className="font-bold border-b border-black/20 pb-1 max-w-max text-[14px]" style={{ color: brand.onSurface }}>Read &rarr;</span>
              </div>
            </div>
      ...
      <motion.section
        ...
        <div className="absolute inset-0 z-0 bg-center bg-cover bg-no-repeat " style={{ backgroundImage: "url('/images/roastery/nathan-dumlao-xPSBoaJNs2g-unsplash.jpg')" }}>
