...
const DIVISIONS = [
  { glyph: '◈', name: 'Kemitraan Sales / Ekspor', mail: 'sales@kopitera.com', tel: '+62 22 4567 890 ext. 1', desc: 'Pricing, contract, & shipment schedule' },
  { glyph: '◎', name: 'Logistik & Hub Kebun', mail: 'logistic@kopitera.com', tel: '+62 22 4567 890 ext. 2', desc: 'Tracking, warehouse, & container booking' },
  { glyph: '◆', name: 'Hubungan Media / PR', mail: 'media@kopitera.com', tel: '+62 22 4567 890 ext. 3', desc: 'Press inquiries & editorial partnerships' },
];

const INFO_ITEMS = [
  { glyph: '○', label: 'Alamat Kantor', value: 'Jalan Perkebunan Raya No. 42\nBandung, Jawa Barat 40123' },
  { glyph: '◊', label: 'Jam Operasional', value: 'Senin – Jumat\n08.00 – 17.00 WIB' },
  { glyph: '·', label: 'Telepon Utama', value: '+62 22 4567 890' },
  { glyph: '·', label: 'Email Umum', value: 'hello@kopitera.com' },
];
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    minHeight: '280px',
                    border: '1px solid var(--coffee-border-gold)',
                    marginTop: i === 1 ? '40px' : '0', // Stagger effect
                  }}
                  whileHover={{ y: -8 }}
                >
                  <div style={{ position: 'absolute', inset: 0, backgroundImage: `url('${bgImages[i]}')`, backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0.4, mixBlendMode: 'luminosity' }} />
                  <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(12,6,4,1) 0%, rgba(12,6,4,0.4) 60%, rgba(12,6,4,0.1) 100%)' }} />
                  
                  <div style={{ position: 'relative', zIndex: 2 }}>
                    <div style={{ color: 'var(--coffee-gold)', marginBottom: '16px', fontSize: '24px', fontWeight: 400 }}>{item.glyph}</div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {DIVISIONS.map((div, i) => (
                    ...
                    >
                      <div style={{ color: 'var(--coffee-gold)', flexShrink: 0, marginTop: 2, fontSize: '16px', fontWeight: 400 }}>{div.glyph}</div>
                      <div>
          ...
          <Reveal>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', background: 'var(--coffee-border-gold)', border: '1px solid var(--coffee-border-gold)', borderRadius: '10px', overflow: 'hidden' }} className="coffee-social-strip">
              ...
              {[
                ...
                { icon: '◎', value: '4.9/5', label: 'Rating Kepuasan Mitra' },
                { icon: '◆', value: '240+', label: 'Ton Kapasitas / Tahun' },
              ].map((s, i) => (
                <motion.div
                  key={i}
