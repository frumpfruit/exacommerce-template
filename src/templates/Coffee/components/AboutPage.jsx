...
import { Leaf, ShieldCheck, Scale, Mountain, Map, Package, Activity } from 'lucide-react';
...
const TIMELINE = [
  { year: '2015', title: 'Pendirian KOPITERA', desc: 'Lahir di Bandung Barat dengan misi memutus rantai pasok panjang yang merugikan petani kopi rakyat.', icon: Mountain },
  { year: '2018', title: 'Ekspansi Kebun & Koperasi', desc: 'Membentuk kemitraan langsung dengan 12 koperasi tani di Gayo, Sidikalang, dan Toraja.', icon: Map },
  { year: '2021', title: 'Ekspor Perdana ke Asia Timur', desc: 'Mengekspor 40 ton green beans berkualitas komersial dan mikro-lot ke Jepang dan Korea Selatan.', icon: Package },
  { year: '2024', title: 'Sertifikasi Organik & Standar SCA', desc: 'Membangun cupping lab mandiri berlisensi SCA untuk menjamin konsistensi mutu rasa produk.', icon: Activity },
];
...
const VALUES = [
  { id: 'I', icon: Leaf, title: 'Keberlanjutan', desc: 'Setiap bibit dan pupuk yang digunakan petani mitra didukung oleh program pertanian ramah lingkungan bebas bahan kimia berlebih.', color: 'var(--coffee-gold)' },
  { id: 'II', icon: ShieldCheck, title: 'Integritas Produk', desc: 'Kami menjamin keaslian asal usul single-origin beans kami. Tidak ada pencampuran varietas batch tanpa sepengetahuan roastery mitra.', color: 'var(--coffee-coral)' },
  { id: 'III', icon: Scale, title: 'Ekonomi Keadilan', desc: 'Sistem bagi hasil dan pembayaran tepat waktu bagi kelompok tani binaan KOPITERA menjadi pilar stabilitas rantai pasok kami.', color: 'var(--coffee-gold)' },
];
          ...
          <div style={{ position: 'relative' }}>
            ...
            {TIMELINE.map((milestone, idx) => (
              <Reveal key={idx} delay={idx * 0.12} direction="left">
                ...
                >
                  <motion.div
                    style={{ position: 'absolute', left: 12, top: 8, width: 24, height: 24, borderRadius: '50%', backgroundColor: 'var(--coffee-bg-dark)', border: '2px solid var(--coffee-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                    whileHover={{ scale: 1.3, borderColor: 'var(--coffee-coral)' }}
                  >
                    <milestone.icon size={12} color="var(--coffee-gold)" />
                  </motion.div>
          ...
          <div className="coffee-values-bento" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
            ...
            {VALUES.map((v, i) => (
              <Reveal key={i} delay={i * 0.12}>
                ...
                >
                  <div style={{ marginBottom: '20px' }}><v.icon size={24} color="var(--coffee-gold)" /></div>
